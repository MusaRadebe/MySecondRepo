...
public:
	...
	string::size_type width() const { return width_; }          ///4.2 Case 1: This function does not modify data members of the Screen class
	...
	void set( const string& s );                          ///4.2. Case 2:the object is passed by reference into this function and it is not modifiable
	...
	void drawSquare(string::size_type x,string::size_type y,string::size_type length);

private:
	// constants
	// 0 represents the top-left screen element
	const string::size_type TOP_LEFT = 0;   ///4.2 Case 3: this variable is declared const so that it
	                                        /// cannot be modified by member functions
